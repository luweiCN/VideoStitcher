...
import {
  ArrowLeft, Upload, Loader2, Play, Trash2, CheckCircle, Check,
  Image as ImageIcon, XCircle, AlertCircle, Image, Layers, Settings, Eye
} from 'lucide-react';
    ...
    const loadAllThumbnails = async () => {
      try {
        const thumbnailResults = await Promise.all(
          filePaths.map(file => window.api.getPreviewThumbnail(file))
        );
    ...
    <div className="h-screen bg-black text-slate-100 flex flex-col">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="flex-1 bg-black flex flex-col overflow-hidden min-w-0">
          ...
          {/* 选中任务详情 */}
          {files[currentIndex] && (
            <div className="px-3 py-2 bg-black/30 border-b border-slate-800 shrink-0">
