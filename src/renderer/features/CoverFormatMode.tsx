    ...
    <div className="min-h-screen bg-slate-950 text-white p-6">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-3">
          <h1 className="text-2xl font-bold text-fuchsia-400">封面格式转换器</h1>
          <button
      ...
      {showHelp && (
        <div className="mb-6 p-4 bg-slate-900 border border-slate-800 rounded-xl">
          <h3 className="font-bold mb-2 text-fuchsia-400">使用说明</h3>
          <ul className="text-sm text-slate-300 space-y-1">
            <li>• 自动检测画面比例并转换到标准尺寸</li>
            <li>• 横版 (宽&gt;高) → 1920x1080</li>
            <li>• 竖版 (高&gt;宽) → 1080x1920</li>
            <li>• 方形 (比例≈1:1) → 800x800</li>
            <li>• 支持批量处理, 自动添加尺寸后缀</li>
          </ul>
        </div>
      )}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-4">
            ...
            {progress.total > 0 ? (
              <div className="space-y-2">
                <div className="text-center">
                  <span className="text-3xl font-bold text-fuchsia-400">{progress.done}</span>
          ...
          <button
            ...
            className="w-full py-4 bg-gradient-to-r from-fuchsia-500 to-fuchsia-600 hover:from-fuchsia-600 hover:to-fuchsia-700 disabled:from-slate-700 disabled:to-slate-700 disabled:cursor-not-allowed rounded-xl font-bold text-lg transition-all flex items-center justify-center gap-2"
          >
            {isProcessing ? (
              <>
