 ...
 * 3. 封面图作为第一帧（静音）
 *
 * 输出尺寸：1920x1080 @ 30fps
 */

/**
 * 构建横屏极速合成的 FFmpeg 命令行参数
 *
...
function buildArgs({ aPath, bPath, outPath, bgImage, coverImage }) {
  ...
  console.log('[DEBUG horizontalMerge] 有背景图:', !!bgImage, '有封面图:', coverIndex >= 0);
  console.log('[DEBUG horizontalMerge] filter_complex:', filterComplex);
